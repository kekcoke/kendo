# Architecture Spec — Day 26 — Gateway JWT Auth Refactor
...
Day 26 — CF-2 Unit 1 of 3 | Milestone: CF-2 (carry-forward)
...
- `src/Shared/Authentication/TokenService.cs` — new
- `src/Shared/Authentication/ITokenService.cs` — new interface
...
Day 26 — CF-2 Unit 2 of 3 | Milestone: CF-2 (carry-forward)
...
- `src/Shared/Authentication/RsaKeyProvider.cs` (modified — add rotation method)
...
Day 26 — CF-2 Unit 3 of 3 | Milestone: CF-2 (carry-forward)
...
- `src/Shared/Authentication/` — the directory containing the auth infrastructure to be modified
- `src/Gateway/Controllers/TokenController.cs` — new controller in Gateway
